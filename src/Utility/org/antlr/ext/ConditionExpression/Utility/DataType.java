...
public class DataType
{
	...
	*/
	public static boolean IsNumber(Object value)
	{
		...
		if (value instanceof Integer || value instanceof Double || value instanceof Byte || value instanceof Short || value instanceof Short || value instanceof Byte || value instanceof Integer || value instanceof Long || value instanceof Long || value instanceof Float || value instanceof java.math.BigDecimal)
		{
			return true;
		}
		return false;
	...
	*/
	public static java.util.Date GetDateTime(Object value)
	{
		...
		else
		{
			...
			//RefObject<java.util.Date> tempRef_t = new RefObject<java.util.Date>(t);
			//java.util.Date.TryParse(value.toString(), tempRef_t); //尝试解析DateTime如果不成功返回DateTime.MinValue
...
//		else
//		{
//			//RefObject<java.util.Date> tempRef_t = new RefObject<java.util.Date>(t) MZHY;
////			boolean tempVar = java.util.Date.TryParse(value.toString(), tempRef_t);
////				t = tempRef_t.argvalue;
////			if (tempVar)
////			{
////				return t.ToOADate();
